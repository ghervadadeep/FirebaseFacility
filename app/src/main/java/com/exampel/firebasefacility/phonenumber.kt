...
class phonenumber : Fragment() {
    ...
    lateinit var submitnumber: Button
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        submitnumber.setOnClickListener {
            ...
            callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                override fun onVerificationCompleted(credential: PhoneAuthCredential) {
                    ...
                    //     user action.
                    Log.d("PASS", "onVerificationCompleted:$credential")
            ...
            val options = PhoneAuthOptions.newBuilder(auth)
                .setPhoneNumber("+91${phonenumber.text.toString()}") // Phone number to verify
        ...
        submitotp.setOnClickListener {
            ...
            val credential =
                PhoneAuthProvider.getCredential(storedVerificationId!!, "${otp.text.toString()}")
